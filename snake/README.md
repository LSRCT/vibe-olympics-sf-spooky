...
Un juego de serpiente basado en React creado para la competencia Sssnake.
...
✅ Fin del juego al colisionar consigo misma
...
- **Espacio**: Reiniciar después de fin del juego
